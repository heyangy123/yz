...
//计算天数差
UT.daysBetween2D = function(before,after){
	var dateLong=after.getTime()-before.getTime();
	var days=Math.floor(dateLong/(24*3600*1000));
	return days;
}

UT.isMoney = function (value) {
...
UT.isZipCode = function (value) {
	var regexp=/^[1-9]\d{5}$/;
    return regexp.test(value);
}

//某个数组中是否包含另一个数组
UT.isContained = function(a, b){
