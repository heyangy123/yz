...
<html>
  <head>	
		...
		.time{
			font-size: 12px;color:#a8a8a8;font-family: Tahoma, Helvetica, Arial, "微软雅黑","华文细黑", "宋体", sans-serif;
		}
        </style>
  </head>
  <body>
	<div class="pin">
		<div class="article-detail">
			...
			<div class="subtitle">
				<span  class="time"><fmt:formatDate value="${obj.createTime}" pattern="yyyy-MM-dd" /></span>
			</div> 
