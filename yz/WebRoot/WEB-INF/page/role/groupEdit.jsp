...
<script type="text/javascript">
	...
	var submitForm = function($dialog, $grid, $pjq, $mainMenu) {
		if ($('form').form('validate')) {
			var url = sy.contextPath + '/addgroup.do';
	...
	$(function() {
		if (id != '') {
			$.post(sy.contextPath + '/findgroup.do', {
				id : id
			}, function(result) {
				if (result) {
            ...
            <table style="table-layout:fixed;" border="0" cellspacing="0" class="formtable">
                ...
                <tr>
                 ...
                 <tr>
                    ...
                    <td>   
                    	 <input id="className" name="className" class="easyui-textbox" data-options="required:true" missingMessage="(如:AdminService)" style="width: 90%;"/>
                    </td>
                </tr>
                <tr>
